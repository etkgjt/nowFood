            ...
            <View>
                ...
                <ScrollView style={{ padding: 5 }}>
                    ...
                    <View style={styles.sectionView}>
                        <Section title={sectionData.title} items={sectionData.items} />
                    </View>
                    <View style={styles.sectionView}>
                        <Section title='Popular' items={sectionData.items} />
                    </View>
                    <View style={styles.sectionView}>
                        <Section title='Free Ship' items={sectionData.items} />
                    </View>
                    <View style={styles.sectionView}>
                        <Section title='Family' items={sectionData.items} />
                    </View>
